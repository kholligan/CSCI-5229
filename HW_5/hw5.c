                 ...
                 double th)
{
   ...
   cube(0,0,0, 0.75,0.75,0.75, 0);  //Center
   cube(-1,0,0, 0.25,0.25,0.75, 0); //Left
   cube(1,0,0, 0.25,0.25,0.75, 0);  //Right
...
static void drawSwing()
{
   ...
   drawCylinder(0.05f, 7.5, 45.0f, 45.0f);
...
int main(int argc,char* argv[])
{
   ...
   glutCreateWindow("hw5 - Kevin Holligan");
   //  Set callbacks
